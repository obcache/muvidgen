      ...
      <div className="grid">
        ...
        <div className="right section-block">
          <div className="section-header">
            ...
            <div className="pill-btn pill-btn:active">
            <button className="pill-btn" style={{border: '0px',padding: '0px 0px'}} type="button" onClick={() => { setTimelineZoom((z) => Math.max(0.25, z / 2)); setTimelineScroll(0); }}>
            ...
            <button className="pill-btn"  style={{ border: '0px',padding: '0px 0px' }} type="button" onClick={() => { setTimelineZoom((z) => Math.min(8, z * 2)); setTimelineScroll(0); }}>
        ...
        <div className="right section-block">
          ...
          {!collapsed.project && (
            <div className="section-body" style={{ position: 'relative' }}>
              ...
              <div style={{ pointerEvents: projectLocked ? 'none' : 'auto', opacity: projectLocked ? 0.55 : 1 }}>
